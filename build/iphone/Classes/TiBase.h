...
// in simulator we redefine to format for XavierMobile Developer console
...
{\
	NSString * exceptionName = [@"org.xaviermobile." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.xaviermobile";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIXavierMobileNativeItemNone = -1, 
	UIXavierMobileNativeItemSpinner = -2,
	UIXavierMobileNativeItemProgressBar = -3,
	
	UIXavierMobileNativeItemSlider = -4,
	UIXavierMobileNativeItemSwitch = -5,
	UIXavierMobileNativeItemMultiButton = -6,
	UIXavierMobileNativeItemSegmented = -7,
	
	UIXavierMobileNativeItemTextView = -8,
	UIXavierMobileNativeItemTextField = -9,
	UIXavierMobileNativeItemSearchBar = -10,
	
	UIXavierMobileNativeItemPicker = -11,
	UIXavierMobileNativeItemDatePicker = -12,
	
	UIXavierMobileNativeItemInfoLight = -13,
	UIXavierMobileNativeItemInfoDark = -14,
	
	UIXavierMobileNativeItemDisclosure = -15,
	
	UIXavierMobileNativeItemContactAdd = -16
};
